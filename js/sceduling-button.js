  ...
  try {
    ...
    var f = function () {
      ...
      q = function (a, b) {
        ...
        for (let d = 0; d < c.length; d++)
          (a.sandbox.supports && !a.sandbox.supports(c[d])) ||
            a.sandbox.add(c[d]);
        b = n(b);
        b !== void 0 && (a.src = b);
      },
      ...
      C = function (targetEl, params) {
        targetEl.onclick = () => {
          const c = document.body,
            d = x(y(params.url, params.label), targetEl);
          c.appendChild(d);
        };
        return targetEl;
      },
    ...
    window.calendar.schedulingButton = {
      load: function (params) {
        ...
        C(targetElement, params);
        
        L ||
          ((targetElement = document.createElement("link")),
          t(
            targetElement,
            u`https://fonts.googleapis.com/css?family=Google+Sans_old:400,500`
          ),
          document.head.appendChild(targetElement));
        L = !0;
        M ||
          ((targetElement = document.createElement("link")),
          t(targetElement, u`https://fonts.googleapis.com/icon?family=Material+Icons`),
          document.head.appendChild(targetElement));
        M = !0;
      },
    };
